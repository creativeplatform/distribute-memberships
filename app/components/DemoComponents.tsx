      ...
      <Card title="Membership Tiers & Features">
        <div className="space-y-6">
          ...
          <div className="relative">
                    ...
                    <div className="bg-gradient-to-br from-[var(--app-card-bg)] to-[var(--app-card-border)] rounded-xl p-6 border border-[var(--app-card-border)]">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-bold text-[var(--app-accent)] flex items-center">
                          <Icon name={tier.icon as any} className="mr-2" />
                          {tier.name} Tier
                        </h3>
                      ...
                      <ul className="space-y-3">
                        {tier.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-start">
                            <Icon name="check" className="text-[var(--app-accent)] mt-1 mr-3 flex-shrink-0" />
            ...
            >
              <svg className="w-4 h-4 text-[var(--app-foreground)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Button variant="outline" onClick={() => setActiveTab("home")} className="mt-4">
          Back to Home
        </Button>
      </Card>
    </div>
